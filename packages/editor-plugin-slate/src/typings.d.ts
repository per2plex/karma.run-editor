...
declare module 'slate' {
  ...
  class Document<DataMap = {[key: string]: any}> extends BaseNode<DataMap> {
    object: 'document'
  ...
  export class BaseNode<DataMap = {[key: string]: any}> extends Immutable.Record({}) {
  ...
  export class Change extends Immutable.Record({}) {
    ...
    setInlinesAtRange(range: Range, properties: InlineProperties | string): Change
