...
function hasValueForKeyPathRecurse(
  ...
  if (keyPath.length === depth + 1) {
    ...
    return hasValueForKeyPathRecurse(value, keyPath, ignoreValues, depth + 1)
  }
}
...
function getValueForKeyPathRecurse(
  ...
  if (keyPath.length === depth + 1) {
    ...
    return getValueForKeyPathRecurse(value, keyPath, defaultValue, depth + 1)
  }
}
 ...
 */
export function getValueForKeyPath(obj: any, keyPath: KeyPath, defaultValue?: any): any {
