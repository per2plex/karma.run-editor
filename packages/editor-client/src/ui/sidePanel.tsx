...
export class SidePanel extends React.Component<SidePanel.Props, SidePanel.State> {
  ...
  public render() {
    ...
    const searchInputResults = this.state.searchResult.map(
      searchResult =>
        ({
    ...
    return (
      <ThemeContext.Consumer>
        {context => (
          <div className={SidePanel.Style(context.colors)}>
            <div className="wrapper">
              <div className="content">
                ...
                <div className="viewContexts">{groupSections}</div>
                {editorContextSelect}
              </div>
              <SidePanelFooter
                username={this.props.editorStore.session!.username}
                endpoint={
                  this.props.editorStore.session!.database ||
                  this.props.editorStore.session!.endpoint
                }
