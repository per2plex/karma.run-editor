...
export class DateFilterValueStore {
  @observable.ref public rawValue: Date | string
...
export class BooleanFilterValueStore {
  @observable.ref public value: boolean = false
...
export class FilterStore {
  @observable.ref public selectedFieldID: string | undefined

  @observable.ref public selectedConditionID: string | undefined

  @observable.ref public valueStore: FilterValueStore | undefined
  ...
  public setConditionID(id: string | undefined) {
    ...
    if (this.selectedCondition) {
      if (
        oldCondition == undefined ||
        !isTypeValueCompatible(oldCondition.type, this.selectedCondition.type)
      ) {
