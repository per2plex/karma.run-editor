...
export class Button extends React.Component<Button.Props> {
  ...
  public render() {
    return (
      <button className={`${Button.Style} ${buttonStyleForType(this.props.type)}`}
...
export class LocationButton extends React.Component<LocationButton.Props, LocationButton.State> {
  ...
  public render() {
    return (
      <a className={`${Button.Style} ${buttonStyleForType(this.props.type)}`}
...
export namespace Button {
  ...
  export const IconStyle = style({
    ...
    $nest: {
      ...
      [`&:hover > .content > .${Icon.Style}, &:active > .content > .${Icon.Style}, &[data-active] > .content > .${Icon.Style}`]: {
...
function buttonStyleForType(type?: ButtonType) {
  switch (type) {
    case ButtonType.Link: return Button.LinkStyle
    case ButtonType.Icon: return Button.IconStyle
    case ButtonType.Light: return Button.Light

    default:
    case ButtonType.Primary: return Button.PrimaryStyle
  }
}
