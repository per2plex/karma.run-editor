  ...
  <svg xmlns='http://www.w3.org/2000/svg' width='24' height='10' viewBox='0 0 24 10'>
    <path opacity='.2' d='M0 0h4v10H0z'>
      <animate attributeName='opacity'
        attributeType='XML' values='0.2; 1; .2' begin='0s' dur='1s' repeatCount='indefinite'/>
    </path>
    <path opacity='.2' d='M8 0h4v10H8z'>
      <animate attributeName='opacity'
        attributeType='XML' values='0.2; 1; .2' begin='0.15s' dur='1s' repeatCount='indefinite'/>
    </path>
    <path opacity='.2' d='M16 0h4v10h-4z'>
      <animate attributeName='opacity'
        attributeType='XML' values='0.2; 1; .2' begin='0.3s' dur='0.6s' repeatCount='indefinite'/>
    </path>
  </svg>
