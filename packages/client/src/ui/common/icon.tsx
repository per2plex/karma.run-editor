...
function nodeForIconName(name: IconName): React.ReactNode {
  switch (name) {
    case IconName.Edit: return <EditDocumentIcon />
    case IconName.Exit: return <LogoutIcon />
    case IconName.SectionCollapse: return <ListArrowDownIcon />
    case IconName.SectionUncollapse: return <ListArrowRightIcon />
    case IconName.EditDocument: return <EditDocumentIcon />
    case IconName.DeleteDocument: return <DeleteDocumentIcon />
    case IconName.NewDocument: return <NewDocumentIcon />
    case IconName.FilterList: return <FilterListIcon />
    case IconName.FilterAscending: return <FilterAscendingIcon />
    case IconName.FilterDescending: return <FilterDescendingIcon />
    case IconName.ArrowUp: return <ArrowUpIcon />
    case IconName.ArrowDown: return <ArrowDownIcon />
    case IconName.ListArrowUp: return <ListArrowUpIcon />
    case IconName.ListArrowDown: return <ListArrowDownIcon />
    case IconName.AddTop: return <ListAddTopIcon />
    case IconName.AddBottom: return <ListAddBottomIcon />
    case IconName.Add: return <ListAddIcon />
    case IconName.Remove: return <ListRemoveIcon />
    case IconName.Clear: return <RemoveIcon />
    case IconName.InsertLink: return <InsertLinkIcon />
    case IconName.RemoveLink: return <RemoveLinkIcon />
    case IconName.FormatBold: return <FormatBoldIcon />
    case IconName.FormatItalic: return <FormatItalicIcon />
    case IconName.FormatStrikethrough: return <FormatStrikethroughIcon />
    case IconName.FormatUnderline: return <FormatUnderlineIcon />
    case IconName.FormatUnorderedList: return <FormatUnorderedListIcon />
    case IconName.FormatOrderedList: return <FormatUnorderedListIcon />
    case IconName.CodeView: return <CodeViewIcon />
    case IconName.Preview: return <PreviewIcon />
    case IconName.Back: return <BackIcon />
    case IconName.Close: return <CloseIcon />
    case IconName.SaveDocument: return <SaveDocumentIcon />
    case IconName.CopyDocument: return <CopyDocumentIcon />
    case IconName.ChooseDocument: return <ChooseDocumentIcon />
  }
}
  ...
  public render() {
    return (
      <span className={Icon.Style}>
        {nodeForIconName(this.props.name)}
      </span>
    )
  }
}
