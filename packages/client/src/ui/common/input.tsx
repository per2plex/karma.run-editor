...
export class TextInput extends React.Component<TextInput.Props> {
  ...
  public render() {
    ...
    switch (this.props.type) {
      default:
      case TextInputType.Lighter: style = TextInput.LighterStyle; break
      case TextInputType.Light: style = TextInput.LightStyle; break
      case TextInputType.Dark: style = TextInput.DarkStyle; break
    }

    return (
      <input className={`${InputStyle} ${style}`}
...
export class CheckboxInput extends React.Component<CheckboxInput.Props> {
  ...
  public render() {
    return (
      <input className={CheckboxInputStyle}
        type='checkbox'
...
export class DateTimeInput extends React.Component<DateTimeInput.Props> {
  ...
  public render() {
    ...
    return (
      <Datetime className={DateTimeInputStyle} inputProps={{className: InputStyle}} utc={true}
        value={this.props.value as any} onChange={this.handleChange} />
    )
  }
}
  ...
  public render() {
    ...
    return (
      <div className={DropAreaFileInputStyle} onClick={this.handleClick} onDrop={this.handleDrop}>
        {content}
        <input ref={element => this.fileInputElement = element}
          className={`${DropAreaFileInputStyle}_fileInput`}
          type='file' onChange={this.handleInputChange} />
      </div>
    )
  }
}
