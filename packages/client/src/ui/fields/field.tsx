...
import {
  fieldColorForDepthAndIndex, Spacing, Color,
  FontWeight, DefaultBorderRadiusPx, FontSize,
  innerShadow
} from '../../ui/style'
...
export class Field extends React.Component<Field.Props> {
  public render() {
    ...
    const classname = classNames(
      Field.Style,
      this.props.depth === 0 ? Field.RootStyle : undefined,
...
export class FieldLabel extends React.Component<FieldLabel.Props> {
  public render() {
    ...
    return (
      <div className={classNames(FieldLabel.Style, this.props.depth === 0 ? FieldLabel.RootStyle : undefined)}>
        {this.props.leftContent && (
...
export class FieldInset extends React.Component {
  public render() {
    ...
    return (
      <div className={FieldInset.Style}>
        {this.props.children}
      </div>
    )
  }
...
export namespace FieldWrapper {
  ...
  export const RootStyle = style({
    ...
    $nest: {
      ...
      [`> .${Field.RootStyle}:first-child`]: {
        borderBottomLeftRadius: 0,
        borderBottomRightRadius: 0
      },

      [`> .${Field.RootStyle}:last-child`]: {
        borderRadius: DefaultBorderRadiusPx
      }
    }
  })
