...
@observer
export class MapFieldRenderer extends React.Component<MapFieldRenderer.Props, MapFieldRenderer.State> {
  ...
  public render() {
    ...
    let tabList = (
      <EditableTabList ref={tabListElement => this.tabListElement = tabListElement}
        values={tabValues}
