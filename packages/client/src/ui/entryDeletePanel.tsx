...
@observer
export class EntryDeletePanel extends React.Component<EntryDeletePanel.Props, EntryDeletePanel.State>
  ...
  private handleDeleteClick = async () => {
    ...
    try {
      await this.props.editorStore.deleteEntry(
  ...
  public render() {
    ...
    return (
      <Panel>
        ...
        {this.state.entry && (
          <GraphView ref={graphView => this.graphView = graphView}
