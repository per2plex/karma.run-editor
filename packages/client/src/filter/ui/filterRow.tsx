...
import {
  InputStyle, Select, TextInput, NumberInput,
  Button, DateTimeInput, CheckboxInput, ButtonType
} from '../../ui/common'

import {
  FilterStore, FilterValueStore, DateFilterValueStore,
  StringFilterValueStore, NumberFilterValueStore, RefFilterValueStore, OptionsFilterValueStore, BooleanFilterValueStore
  ...
  public render() {
    return (
      <div className={FilterRowStyle}>
        <div className='types'>
          <Select options={this.props.store.availableFields}
        ...
        <div className='condition'>
          {this.props.store.selectedFieldID && (
            <Select options={this.props.store.availableConditions}
        ...
        <div className='value'>
          {this.props.store.selectedCondition && (
            <ConditionField store={this.props.store.valueStore!}
              onEntryChoose={this.props.onEntryChoose} />
          )}
        </div>
        <div className='actions'>
          {this.props.onRemove && (
            <Button type={ButtonType.Icon} onTrigger={this.handleRemoveClick} icon={IconName.Remove} />
          )}
          {this.props.onAdd && (
    ...
    return (
      <div className={RefConditionFieldStyle}>
        <div className='content'>
          {this.props.store.value || 'No reference selected'}
        </div>
