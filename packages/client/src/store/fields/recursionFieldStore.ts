...
export class RecursionFieldStore implements FieldStore {
  ...
  public get recursionStore(): FieldStore | undefined {
    const recursionMap = this.recursions.reduce((prev, recursionMap) => {
  ...
  public clone(opts?: FieldStoreOptions) {
    return new RecursionFieldStore(this.recursions, Object.assign(
      {}, this, {store: this.store && this.store.clone()}, opts)
    )
  }
}
