...
export interface IntFieldStoreOptions extends FieldStoreOptions {
  value?: number
}

export class IntFieldStore implements FieldStore {
  ...
  constructor(opts: IntFieldStoreOptions) {
  ...
  @computed public get hash() {
    return hashString(`int:${this.value}`)
  }
  ...
  public clone(opts?: FieldStoreOptions) {
    return new IntFieldStore(Object.assign({}, this, opts))
  }
}
